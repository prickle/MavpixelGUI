...
public static class MavlinkUtil
{
    ...
    public static TMavlinkPacket ByteArrayToStructure<TMavlinkPacket>(this byte[] bytearray, int startoffset)
        where TMavlinkPacket : struct
    {
        return ReadUsingPointer<TMavlinkPacket>(bytearray, startoffset);
    }
    public static TMavlinkPacket ByteArrayToStructure<TMavlinkPacket>(this byte[] bytearray)
        where TMavlinkPacket : struct
    {
        return ReadUsingPointer<TMavlinkPacket>(bytearray, 6);
    }

    public static TMavlinkPacket ByteArrayToStructureBigEndian<TMavlinkPacket>(this byte[] bytearray,
        int startoffset) where TMavlinkPacket : struct
    {
    ...
    {
        object newPacket = new TMavlinkPacket();
        ByteArrayToStructureEndian(bytearray, ref newPacket, 6);
        return (TMavlinkPacket) newPacket;
    }

    public static void ByteArrayToStructure(byte[] bytearray, ref object obj, int startoffset)
    {
        ByteArrayToStructure(bytearray, ref obj, startoffset, 0);
    }

    public static void ByteArrayToStructure(byte[] bytearray, ref object obj, int startoffset,int payloadlength)
    {
